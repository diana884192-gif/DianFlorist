...
<html>
    ...
    <body>
        <div class="container mt-5">
            ...
            <h2 class="text-center mb-4" style="color: deeppink;"> 🌸Data Jenis Bunga🌸</h2>
            ...
            <a href="/jenis_bunga/create" class="btn text-white" style="background-color: hotpink;"> 🌷 Tambah Jenis Bunga 
            </a>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>{{ $j->nama_jenis }}</td>
                    <td> 
                        <a href="/jenis_bunga/{{ $j->id }}/edit" class="btn btn-warning btn-sm"> ✏ Edit</a>
